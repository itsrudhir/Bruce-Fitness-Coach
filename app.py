...
# # Initialize offline TTS engine for fallback
# engine = pyttsx3.init()
...
#         with open("input.wav","wb") as f: f.write(audio_bytes)
#         r = sr.Recognizer()
...
#             st.session_state.messages.insert(0, {"role":"system","content":"You are a helpful fitness coach. Provide personalized workouts, nutrition tips, and motivation. Dont give too lengthy messages Keep responses and relevant to the user's query. Do not respond to anything other than fitness and nutrition advice."})
...
#             engine.save_to_file(reply, fallback_path)
#             engine.runAndWait()
